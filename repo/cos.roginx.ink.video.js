...
export default class extends Extension {
    jmcomic = {
        ...
        "bookSourceName": "腾讯视频",
        "bookSourceType": 2,
        "bookSourceUrl": "https://v.qq.com/",
        "customOrder": -2085984643,
        "enabled": true,
        "enabledCookieJar": false,
        "enabledExplore": true,
        "exploreUrl": "热门::https://v.qq.com/channel/choice\n电影::https://v.qq.com/channel/movie\n动漫::https://v.qq.com/channel/cartoon",
        ...
        "ruleExplore": {
            "bookList": ".video-banner-item",
            "bookUrl": "tag.a.0@href",
            "coverUrl": "class.banner-cover@data-src",
            "intro": "",
  ...
  */
  attr(doc,attrStr){
    ...
    async latest(page) {
        ...
        const url = new URL(matches["电影"].replace("{{page}}",page));
