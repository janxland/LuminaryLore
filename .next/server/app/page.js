...
/* harmony import */ var next_dist_compiled_react_server_dom_webpack_server_edge__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(6370);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 6594)), "E:\\project\\xuexi\\LuminaryLore\\app\\page.tsx"],
    ...
    const pages = ["E:\\project\\xuexi\\LuminaryLore\\app\\page.tsx"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 6750))
...
;// CONCATENATED MODULE: ./app/Collection.tsx
...
const Collection = (0,dist.observer)(()=>{
    const { settingsStore  } = (0,root_context/* useRootStore */.Yh)();
    const { t  } = (0,i18n/* useTranslation */.$)("home");
    const { error , data , isLoading , refetch  } = (0,useQuery/* useQuery */.a)({
        queryKey: [
            "getLoveData"
        ],
        queryFn: async ()=>db/* loveDB.getAllLoveByType */.c8.getAllLoveByType((0,model/* getModel */.P)(settingsStore.getSetting("model")))
    });
    (0,react_.useEffect)(()=>{
        refetch();
    }, [
    ...
    if (!data || data.length === 0) {
        return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
            className: "m-28 text-center text-gray-400",
            children: [
                /*#__PURE__*/ jsx_runtime_.jsx("p", {
                    children: t("no-collection.title")
                }),
                /*#__PURE__*/ jsx_runtime_.jsx("p", {
                    children: t("no-collection.message")
                })
            ]
        });
    }
    return /*#__PURE__*/ jsx_runtime_.jsx(ItemGrid/* default.Grid */.Z.Grid, {
        children: data.map((love)=>/*#__PURE__*/ jsx_runtime_.jsx((link_default()), {
                href: {
                    pathname: "/detail",
                    query: {
                        pkg: love.package,
...
/* harmony default export */ const app_Collection = (Collection);

;// CONCATENATED MODULE: ./components/CheckUpdata.tsx



function CheckUpdate({ pkg , url  }) {
    const { extensionStore  } = (0,root_context/* useRootStore */.Yh)();
    const { data , error  } = (0,useQuery/* useQuery */.a)({
        queryKey: [
            "checkUpdate",
            pkg,
            url
...
;// CONCATENATED MODULE: ./app/ContinueViewing.tsx
/* __next_internal_client_entry_do_not_use__  auto */ 
...
const ContinueVewing = (0,dist.observer)(()=>{
    const { settingsStore , historyStore  } = (0,root_context/* useRootStore */.Yh)();
    const { t  } = (0,i18n/* useTranslation */.$)("home");
    const { error , data , isLoading , refetch  } = (0,useQuery/* useQuery */.a)({
        queryKey: [
            "getHistoryData"
        ],
        queryFn: async ()=>historyStore.getHistoryByType((0,model/* getModel */.P)(settingsStore.getSetting("model")), 8)
    });
    (0,react_.useEffect)(()=>{
        refetch();
    }, [
    ...
    if (!data || data.length === 0) {
        return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
            className: "m-14 text-center text-gray-400",
            children: [
                /*#__PURE__*/ jsx_runtime_.jsx("p", {
                    children: t("no-continue-viewing.title")
                }),
                /*#__PURE__*/ jsx_runtime_.jsx("p", {
                    children: t("no-continue-viewing.message")
                })
            ]
        });
    }
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        className: "-ml-230px flex overflow-auto pb-3 scrollbar-none",
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                className: "ml-230px"
            }),
            data.map((history, index)=>/*#__PURE__*/ jsx_runtime_.jsx("div", {
                    ...
                    children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)((link_default()), {
                        ...
                        children: [
                            history.type === "fikushon" && /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                className: "h-full w-full ",
                                children: /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                    className: "m-auto  h-full rounded bg-slate-200 p-2 text-lg dark:bg-black dark:bg-opacity-40",
                                    children: history.cover
                                })
                            }) || history.cover && /*#__PURE__*/ jsx_runtime_.jsx(LoadingImg["default"], {
                            ...
                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                className: "absolute left-0 right-0 bottom-0 bg-gradient-to-t from-black p-2",
                                children: [
                                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("p", {
                                        className: " mt-3 mb-1 text-xs text-neutral-300",
                                        children: [
                                            /*#__PURE__*/ jsx_runtime_.jsx(CheckUpdate, {
                                                pkg: history.package,
                                                url: history.url
                                            }),
                                            " ",
...
/* harmony default export */ const ContinueViewing = (ContinueVewing);
        ...
        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)(BaseMargin/* default */.Z, {
            children: [
                ...
                /*#__PURE__*/ jsx_runtime_.jsx("h2", {
                    ...
                    children: t("continue-viewing")
                }),
                /*#__PURE__*/ jsx_runtime_.jsx(ContinueViewing, {}),
                /*#__PURE__*/ jsx_runtime_.jsx("h2", {
                    className: "mb-5 text-2xl font-bold",
                    children: t("collection")
                }),
                /*#__PURE__*/ jsx_runtime_.jsx(app_Collection, {})
            ]
        })
    });
}
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`E:\project\xuexi\LuminaryLore\app\page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [690,971,149,811], () => (__webpack_exec__(4040)));
